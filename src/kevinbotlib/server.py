...
def bringup(config_path: str | Path | None, core_port: str | None, core_baud: int | None, xbee_port: str | None, xbee_api: int | None, xbee_baud: int | None, *, verbose: bool, trace: bool):
    ...
    radio = WirelessRadio(robot, xbee_port, xbee_baud, xbee_api, config.xbee.timeout)
