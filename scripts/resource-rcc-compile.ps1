...
pyside6-rcc.exe resources/kevinbotlib/logviewer_resources.qrc -o src/kevinbotlib/apps/log_viewer/resources_rc.py --no-compress
pyside6-rcc.exe resources/kevinbotlib/sim_resources.qrc -o src/kevinbotlib/simulator/resources_rc.py --no-compress
...
(Get-Content src/kevinbotlib/simulator/resources_rc.py) -replace 'PySide6', 'qtpy' | Set-Content src/kevinbotlib/simulator/resources_rc.py
